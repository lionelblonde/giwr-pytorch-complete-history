...
class BCQ2(object):
    ...
    def __init__(self, state_dim, action_dim, max_action, device,
        ...
        self.revae = ReVAE(state_dim, action_dim, latent_dim, device).to(device)
        self.revae_optimizer = torch.optim.Adam(self.revae.parameters())
    ...
    def grad_pen(self, state, action):
        ...
        score, _, _ = self.revae(input_a_i, input_b_i)
    ...
    def train(self, replay_buffer, iterations, batch_size=100, train_vae=False):
        ...
        if train_vae:
            ...
            for i in range(vae_pre):
                ...
                recon, mean, std = self.revae(state, action)
                ...
                # Optimize VAE
                self.revae_optimizer.zero_grad()
                vae_loss.backward()
                self.revae_optimizer.step()
        ...
        for it in range(iterations):
            ...
            _recon, _, _ = self.revae(state, action)
